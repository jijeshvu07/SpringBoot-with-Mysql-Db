			...
			return this.each(
				function()
				{
					...
					if (!alreadyExists && s.createButton) {
						// create it!
						controller.button = $('<a href="#"  class="dp-choose-date"> <i class="fa fa-calendar " style="color:#004a8e;"></i> </a>')
								.bind(
									'click',
									function()
									{
		...
		{	
			...
			display : function(eleAlignTo)
			{
				...
				if (c.inline) {
					...
					cssRules = {
						'top'	:	(eleOffset.top-2) + c.verticalOffset,
						'left'	:	(eleOffset.left-10) + c.horizontalOffset
					};
